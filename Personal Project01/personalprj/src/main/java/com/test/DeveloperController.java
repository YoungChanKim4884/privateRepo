...
public class DeveloperController {
	...
	// /erp/developer_search_form.do로 접근하면 호출되는 메소드 선언
	@RequestMapping(value="/erp/developer_search_form.do")
	public ModelAndView developer_search_form() {
	...
	// /erp/developer_input_form.do로 접근하면 호출되는 메소드 선언
	@RequestMapping(value="/erp/developer_input_form.do")
	public ModelAndView developer_input_form() {
	...
	// /erp/developer_updel_form.do로 접근하면 호출되는 메소드 선언
	@RequestMapping(value="/erp/developer_updel_form.do")
	public ModelAndView developer_updel_form() {
